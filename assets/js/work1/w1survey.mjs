                        ...
                        <template #body>
                            ...
                            <div class="survey__graphs">
                                <div class="survey__graph">
                                    <img-modal :imgprop="{src:'assets/images/work1/work1_graph1.png', alt:'通販利用割合の推移'}">
                                        <template #imageCaption>
                                            <p>図1　インターネットショッピングを年1回以上利用する人の割合の推移</p>
                                            <p class="survey__graphref">出典「生活者1万人アンケート（10回目）に見る日本人の価値観・消費行動の変化」　野村総合研究所　<a class="linkblue"
                                ...
                                <div class="survey__graph">
                                    <img-modal :imgprop="{src:'assets/images/work1/work1_graph2.png', alt:'通販利用回数の推移'}">
                                        <template #imageCaption>
                                            <p>図2　インターネットショッピング利用者の年間平均利用回数の推移</p>
                                            <p class="survey__graphref">出典「生活者1万人アンケート（10回目）に見る日本人の価値観・消費行動の変化」　野村総合研究所　<a class="linkblue"
                                    href="https://www.nri.com/jp/knowledge/report/2025forum384.html" target="_blank"
                                    rel="noopener noreferrer">https://www.nri.com/jp/knowledge/report/2025forum384.html</a></p>
                                        </template>
                    ...
                    <detail-item>
                        ...
                        <template #body>
                            ...
                            <dl>
                                ...
                                <dd class="survey__worddetail">単に「りんご レシピ」といったものや、「りんご コンポート」、「りんご ジャム」、「りんご ケーキ」など料理に関する検索が見られました。また、「りんご 大量消費」というような、おそらく通販サイト等で数kg単位でりんごを購入したと思われる検索もありました。</dd>
                            </dl>
                        </template>
                    </detail-item>
                    <detail-item>
                        ...
                        <template #body>
                            ...
                            <ul class="survey__targetlist">
                                <li>逢振（架空の銘柄のりんご）を通販で購入する時（「りんご」＋「品種」型）</li>
                                <li>振津県外に居住しており、振津県への旅行を検討している時（「りんご」＋「産地」型）</li>
                            </ul>
                            <p class="para-mt15">
                            年齢層は、通販の利用率、利用回数ともに高い20代から30代で、普段から料理をするなど食に関心がある人物像という設定にしました。このため、産地やりんごを使った料理など、商品情報だけでなく、背景も重視する設計が有効と判断しました。
                            </p>
                        </template>
                    </detail-item>
                </dl>
